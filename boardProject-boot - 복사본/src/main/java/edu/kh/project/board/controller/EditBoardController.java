...
public class EditBoardController {
	 ...
	 * @param loginmember : 로그인한 회우너 번호를 얻어오는 용도 (세션에 등록되어있음)
	 ...
	 * @param model       : 포워드 시     requset scope로 값 전달하는 용도
	 ...
	 * @param deleOrderList		: 삭제된 이미지 순서가 기록된 문자열 (1,2,3)
