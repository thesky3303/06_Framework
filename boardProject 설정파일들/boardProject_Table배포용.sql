...
UPDATE MEMBER
SET MEMBER_PW = '$2a$10$.9m6WzdYXqEIfr01MBCmmuyea9x1jiJvZrBTwqstAO9FxksbdvzeO'
...
SELECT BOARD_NO, BOARD_TITLE, MEMBER_NICKNAME, READ_COUNT,
	(SELECT COUNT(*) 
	FROM "COMMENT" C
	WHERE C.BOARD_NO = B.BOARD_NO) COMMNET_COUNT,
...
UPDATE BOARD
SET BOARD_WRITE_DATE = TO_DATE('2024-11-14 10:19:20', 'YYYY-MM-DD HH24:MI:SS')
WHERE BOARD_NO = 1999;
...
-- 현재시간 - 하루 전
SELECT SYSDATE
	- TO_DATE('2024-11-11 11:19:20', 'YYYY-MM-DD HH24:MI:SS')
FROM DUAL;
...
( SELECT COUNT(*)
FROM BOARD_LIKE
WHERE BOARD_NO = 1997 ) LIKE_CHECK
...
VALUES(1, 2009); -- 1번 회원이 1998번 글에 좋아요를 클릭함
...
SELECT NEXT_IMG_NO() FROM DUAL;
  		...
  		IMG_ORIGINAL_NAME = '{imgOrginalName}',
  		IMG_RENAME ='test1.jpg'
  		WHERE BOARD_NO = 1997
  		AND IMG_ORDER = 0;
