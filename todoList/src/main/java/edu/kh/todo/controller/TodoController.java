...
public class TodoController {
	...
	public String addTodo(
		...
		//   -> request scppe -> session scope로 잠시 변환
	...
	// /todo/changeComplete?todoNo=2&complete=N
	/** 완료 여부 변경
	...
	public String update(
		...
		int result = service.update(todoTitle, todoContent, todoNo);
	...
	@GetMapping("delTodo")
	public String delTodo(@RequestParam("todoNo") int todoNo,
			RedirectAttributes ra) {
		
		int result = service.delTodo(todoNo);
